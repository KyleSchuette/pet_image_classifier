...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for filename in results_dic:
      if results_dic[filename][0] in dognames_dic:        # Image is a dog
        if results_dic[filename][1].lower() in dognames_dic: # Classifiction as dog
          results_dic[filename].extend((1,1))
        else:                                             # Classifiction as not a dog
