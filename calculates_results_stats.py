...
# this function
    ...
    for filename in results_dic:
        if results_dic[filename][2]: # Labels match
            results_stats_dic['n_match'] += 1
            if results_dic[filename][3]: # Labels match and image is a dog
                results_stats_dic['n_correct_breed'] += 1 
        if results_dic[filename][3]: # Image is a dog
            results_stats_dic['n_dogs_img'] += 1 
            if results_dic[filename][4]: # Image is a dog and classification is correct
                results_stats_dic['n_correct_dogs'] += 1 
        else: # Image is not a dog
            if not results_dic[filename][4]: # Image is not a dog and classification is correct
                results_stats_dic['n_correct_notdogs'] += 1

    results_stats_dic['n_images'] = len(results_dic) # Total images
